...
void printVirtualPage(VirtualPage page)
{
	printf("valid | permission | ppn | useBit\n");
	printf("|    %i   |   %i   |    %i    |   %i   |\n",
			page.valid, page.permission, page.ppn, page.useBit);
}
    ...
    while (true)
    {
        ...
        if (virtualPages[indexVirt].valid == 0 && virtualPages[indexVirt].permission == 1)
        {
            ...
            * to the first element. */
            ...
            segfault = true;
		//printVirtualPage(virtualPages[indexVirt]);
